...
const getAdminContestById = require("../controller/contest/get-admin-contest-by-id");
...
contestRoutes.post("/get-admin-contest-by-id", authenticateUserJWT, getAdminContestById);
