...
const getGameWiseUpcomingContestList = async (request, response) => {
    try {
        const { page, searchString, gameId } = request.body;

        const contestList = await contestServices.getGameWiseUpcomingContestList(page, searchString, gameId);
...
module.exports = getGameWiseUpcomingContestList